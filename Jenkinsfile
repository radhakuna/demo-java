        ...
        stage('copying the docker to ansible'){
            steps{
                ...
                sshagent(['Ansible-Server']){                               
                    sh 'scp ./target/demo.war ansible@172.31.81.46:/home/ansible/ci-cd-files'
                    sh 'scp dockerplaybook.yml ansible@172.31.81.46:/home/ansible/ci-cd-files'
                    sh 'scp Dockerfile.yml ansible@172.31.81.46:/home/ansible/ci-cd-files'
                  
                    sh '''
                     ssh -tt ansible@172.31.81.46 << EOF
